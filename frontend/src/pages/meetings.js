...
export default function Home() {
  ...
  */}
    ...
    <div>
      <h1 style={{ fontSize: "45px", textAlign: "center" }}>Video Meeting</h1>
      <p style={{ fontWeight: "200", textAlign: "center" }}>Video conference website that lets you stay in touch with all your friends.</p>
    </div>
